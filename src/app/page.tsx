...
export default function Home() {
  ...
  const [generatedImages, setGeneratedImages] = useState<Array<{type: string; image_url: {url: string}}>>([]);
              ...
              <div className="bg-gray-50 rounded-lg p-6 min-h-[400px]">
                {isGenerating ? (
                  ...
                  <div className="w-full space-y-4">
                    <h4 className="text-lg font-semibold text-gray-900">Generated Images:</h4>
                    ...
                    {generatedResult && (
                      <div className="bg-white rounded-lg p-4 shadow-sm mt-4">
                        ...
                        <p className="text-sm text-gray-600">{generatedResult}</p>
                      </div>
                    )}
                  </div>
                ) : (
